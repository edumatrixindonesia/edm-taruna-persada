                ...
                <div class="card-body">
                    <form action="{{ route('page.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="namaSection" class="form-control @error('namaSection') is-invalid @enderror" id="defaultFormControlInput" placeholder="Masukkan Nama Section" value="{{ old('namaSection') }}" />
                            @error('namaSection')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="title" class="form-control @error('title') is-invalid @enderror" id="defaultFormControlInput" placeholder="Masukkan Title Section" value="{{ old('title') }}" />
                            @error('title')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
