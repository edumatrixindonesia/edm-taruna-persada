                ...
                <div class="card-body">
                    <form action="{{ route('tutor.update', $tutor['id']) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="defaultFormControlInput" placeholder="Masukkan Nama Master Teacher" value="{{ $tutor['name'] }}" />
                            @error('name')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="jenjang" id="defaultSelect" class="form-control jenjang @error('jenjang') is-invalid @enderror">
                                <option></option>
                                <option value="S1" {{ $tutor['jenjang'] == 'S1' ? 'selected' : '' }}>S1</option>
                                <option value="S2" {{ $tutor['jenjang'] == 'S2' ? 'selected' : '' }}>S2</option>
                                <option value="S3" {{ $tutor['jenjang'] == 'S3' ? 'selected' : '' }}>S3</option>
                            </select>
                            @error('jenjang')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="university" class="form-control @error('university') is-invalid @enderror" id="defaultFormControlInput" placeholder="Contoh: Universitas Gajah Mada" value="{{ $tutor['university'] }}" />
                            @error('university')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="description" class="form-control @error('description') is-invalid @enderror" id="defaultFormControlInput" placeholder="Masukkan Deskripsi Master Teacher" value="{{ $tutor['description'] }}" />
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
