                ...
                <div class="card-body">
                    <form action="{{ route('testimonial.update', $testimonial['id']) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="siswaName" class="form-control @error('siswaName') is-invalid @enderror" id="defaultFormControlInput" placeholder="Masukkan Nama Siswa" value="{{ $testimonial['siswaName'] }}" />
                            @error('siswaName')
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="description" class="form-control @error('description') is-invalid @enderror" rows="10">{{ $testimonial['description'] }}</textarea>
                            @error('description')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
