...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            ...
            <a class="btn btn-sm btn-primary mb-3" href="{{ route('regency.create') }}">Tambah</a>
                ...
                <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $regency['slug'] }}</td>
                            <td>
                                <a href="{{ route('regency.edit', $regency['id']) }}" class="btn btn-xs btn-warning text-white">Edit</a>
                                <form action="{{ route('regency.destroy', $regency['id']) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
            ...
            <div class="modal fade" id="import" tabindex="-1" aria-hidden="true">
                <form method="POST" action="{{ route('regency.importExcel') }}" enctype="multipart/form-data">
                    @csrf
