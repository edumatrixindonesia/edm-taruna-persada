...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="card">
        <div class="card-body">
            <a class="btn btn-sm btn-primary mb-3" href="{{ route('mapel.create') }}">Tambah</a>
                ...
                <table id="dataTableExample" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $mapel['slug'] }}</td>
                            <td>
                                <a href="{{ route('mapel.edit', $mapel['id']) }}" class="btn btn-xs btn-warning text-white">Edit</a>
                                <form action="{{ route('mapel.destroy', $mapel['id']) }}" method="POST" onsubmit="return confirm('Are you sure?');" style="display: inline-block;">
